      ...
      <div className="flex">
        ...
        <div className="container mx-auto p-4 w-full h-screen overflow-y-scroll">
          ...
          <div className="flex gap-4 mb-6">
            ...
            {user_type === "Admin" && (
              <button className="bg-indigo-600 text-white px-6 py-2 rounded hover:bg-green-700 ml-auto">
                  ...
                  subcontractors?.map((subcontractor) => (
                    <tr key={subcontractor.subcontractor_id}>
                      ...
                      <td className="border text-sm px-4 py-3 flex gap-2">
                        ...
                        <button className="text-red-600 hover:text-red-800" onClick={() => handleDelete(subcontractor.subcontractor_id)}>
