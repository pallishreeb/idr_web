...
const Locations = () => {
  ...
  return (
    ...
    <div className="container mx-auto p-4">
      ...
      {selectedClient !== null && (
        <div className="mb-4">
          <h2 className="text-xl font-semibold mb-2">Locations for {clients.find(client => client.id === parseInt(selectedClient)).name}</h2>
            ...
            <tbody>
              {locations.map((location) => (
                <tr key={location.id}>
                  ...
                  <td className="border px-4 py-2">{location.position}</td>
                  <td className="border px-4 py-2">{location.email}</td>
