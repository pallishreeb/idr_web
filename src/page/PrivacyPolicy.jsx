  ...
  return (
    <div className='p-8'>
      ...
      <ul>
        ...
        <li><strong>Application:</strong> refers to IDR, the software program provided by the Company.</li>
...
<h3 className='mt-2'>We may share Your personal information in the following situations:</h3>
<ul>
