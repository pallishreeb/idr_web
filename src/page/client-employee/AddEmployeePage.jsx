...
const AddEmployeePage = () => {
  ...
  const users = useSelector((state) => state.user.users); // Get users from the user slice
  ...
  useEffect(() => {
    dispatch(getClients());
    dispatch(fetchUsers()); // Fetch users with user_type as "Client Employee"
  }, [dispatch]);
...
// Log the structure and type of users
// console.log("Users:", users);


// Check if users is an array
const filteredUsers = Array.isArray(users.data) ? users.data.filter(user => user.user_type === 'Client Employee') : [];
