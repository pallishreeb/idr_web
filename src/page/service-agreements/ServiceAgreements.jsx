  ...
  return (
    <>
      ...
      <div className="flex">
        ...
        <h2 className="text-xl font-semibold mb-2">Client Service Agreements</h2>
          ...
          {selectedClient !== null && (
            <div className="mb-4">
              <div className="flex justify-end mb-2">
                <button className="bg-indigo-700 text-white px-4 py-2 rounded"><Link to={`/add-service-agreement/${selectedClient}`}>Add New Service Agreement</Link></button>
              </div>
              {loadinglocations ? (
