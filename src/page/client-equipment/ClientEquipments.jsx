                ...
                {equipments?.length === 0 ? (
                  ...
                  equipments?.map((equipment) => (
                    <tr key={equipment.client_equipment_id}>
                      <td className="border px-4 py-2">{equipment.device_type}</td>
                      <td className="border px-4 py-2">{equipment.device_id}</td>
                      <td className="border px-4 py-2">{equipment.manufacturer}</td>
                      <td className="border px-4 py-2">{equipment.model}</td>
                      <td className="border px-4 py-2">{equipment.serial_number}</td>
                      <td className="border px-4 py-2 flex gap-2">
                        <button
                          onClick={() => handleEdit(equipment.client_equipment_id)}
          ...
          {decommissionModal.show && (
            <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
              <div className="bg-white rounded p-6 w-1/3">
                <h3 className="text-lg font-semibold mb-4">Decommission Equipment</h3>
                <textarea
                  name="reason"
