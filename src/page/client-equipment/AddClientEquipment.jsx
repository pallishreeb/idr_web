            ...
            <form onSubmit={handleSave}>
              ...
              <div className="col-span-1">
                    ...
                    <input
                      ...
                      value={clientEquipment.address_line_three}
                      onChange={handleChange}
                      className="w-full mt-1 p-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500"
                    />
                  </div>
                ...
                <div className="col-span-1">
                  ...
                  <div className="col-span-1">
                    ...
                    <input
                      type="text"
                      name="fax_number"
                      value={clientEquipment.fax_number}
                      onChange={(e) => handleChange( e)}
                      className="w-full mt-1 p-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500"
                    />
                  </div>
                  <div className="col-span-1">
                    ...
                    <input
                      type="text"
                      name="phone_number"
                      value={clientEquipment.phone_number}
                      onChange={handleChange}
                      className="w-full mt-1 p-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500"
                    />
                  </div>
