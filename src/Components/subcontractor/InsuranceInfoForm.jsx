...
const InsuranceInfoForm =
  ({
    ...
    useEffect(() => {
      if (
        data?.insurance_requirements?.length >
        0
      ) {
        const insurance =
          data
            .insurance_requirements[0];
        ...
        setFormData(
          (
            ...
            company_vehicles:
              insurance.company_vehicles ||
              "",

            emp_use_personal_vehicles:
              insurance.emp_use_personal_vehicles ||
              false,
            ...
            gl_policy_startdate:
              insurance.gl_policy_startdate ||
              "",

            gl_policy_enddate:
              insurance.gl_policy_enddate ||
              "",
            ...
            ui_policy_startdate:
              insurance.ui_policy_startdate ||
              "",

            ui_policy_enddate:
              insurance.ui_policy_enddate ||
              "",
            ...
            wc_policy_startdate:
              insurance.wc_policy_startdate ||
              "",

            wc_policy_enddate:
              insurance.wc_policy_enddate ||
              "",

            commercial_auto_insurance_policy:
              insurance.commercial_auto_insurance_policy ||
              false,

            hired_nonowned_auto_insurance_policy:
              insurance.hired_nonowned_auto_insurance_policy ||
              false,

            auto_insurer_name:
              insurance.auto_insurer_name ||
              "",

            vehicle_policy_number:
              insurance.vehicle_policy_number ||
              "",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  ...
                  value={
                    formData[
                      `${prefix}_coverage_amount_perocurance`
                    ] ||
                    ""
                  }
                  onChange={
              ...
              <div>
                ...
                <input
                  ...
                  value={
                    formData[
                      `${prefix}_aggregate_coverage_amount`
                    ] ||
                    ""
                  }
                  onChange={
          ...
          >
            ...
            <div className="bg-white rounded-[28px] border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={
                        formData.vehicle_policy_number
                      }
                      onChange={
                        handleChange
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={
                        formData.vehicle_bodily_injury_per_person
                      }
                      onChange={
                        handleChange
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={
                        formData.vehicle_bodily_injury_per_accident
                      }
                      onChange={
                        handleChange
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={
                        formData.vehicle_property_damage_per_accident
                      }
                      onChange={
                        handleChange
                      }
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      value={formatToInput(
                        formData.vehicle_policy_startdate,
                      )}
                      onChange={(
                        e,
                      ) =>
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      value={formatToInput(
                        formData.vehicle_policy_enddate,
                      )}
                      onChange={(
                        e,
                      ) =>
                ...
                {/* CHECKBOX */}
                <label className={`flex items-start gap-4 p-5 rounded-2xl border border-gray-200 mt-6 transition-all duration-300 ${
            ...
            <div className="bg-white rounded-[28px] border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  ...
                  {/* CHECKBOXES */}
                  <label className={`flex items-center gap-3 p-4 rounded-2xl border border-gray-200 ${
